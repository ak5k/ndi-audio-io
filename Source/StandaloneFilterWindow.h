                               ...
                               private Value::Listener
{
  public:
    ...
    */
    ...
    {
        stateFileChooser = std::make_unique<FileChooser>(
            TRANS("Save current state"), getLastFile(),
    ...
    {
        stateFileChooser = std::make_unique<FileChooser>(
            TRANS("Load a saved state"), getLastFile(),
            getFilePatterns(fileSuffix));
    ...
    void showAudioSettingsDialog()
    {
        ...
        maxNumInputs = jmax(0, 256);

        // if (auto* bus = processor->getBus(false, 0))
        maxNumOutputs = jmax(0, 256);
        ...
        const AudioDeviceManager::AudioDeviceSetup* preferredSetupOptions)
    {
        ...
        deviceManager.initialise(enableAudioInput ? inputChannels : 0,
                                 outputChannels, savedState.get(), true,
    ...
    class CallbackMaxSizeEnforcer : public AudioIODeviceCallback
    {
      public:
        ...
        void audioDeviceAboutToStart(AudioIODevice* device) override
        {
            ...
            storedInputChannels.resize((size_t)device->getActiveInputChannels()
            ...
            const AudioIODeviceCallbackContext& context) override
        {
            ...
            while (position < numSamples)
            {
                ...
                inner.audioDeviceIOCallbackWithContext(
                    storedInputChannels.data(), (int)storedInputChannels.size(),
        ...
        void resized() override
        {
            ...
            if (owner.getProcessorHasPotentialFeedbackLoop())
            {
                ...
                shouldMuteButton.setBounds(Rectangle<int>(
                    extra.proportionOfWidth(0.35f), seperatorHeight,
...
/**
   ...
   same createPluginFilter() function that the other plugin wrappers use.
    ...
    @tags{Audio}
*/
class StandaloneFilterWindow : public DocumentWindow, private Button::Listener
{
  public:
    //==============================================================================
    ...
    */
    StandaloneFilterWindow(
        ...
        : DocumentWindow(title, juce::Colour(0xff0e0e0e),
        ...
        , optionsButton("Menu")
    {
        ...
        pluginHolder.reset(new StandalonePluginHolder(
            settingsToUse, takeOwnershipOfSettings, preferredDefaultDeviceName,
        ...
        const auto windowScreenBounds = [this]() -> Rectangle<int> {
            ...
            return {displayArea.getCentreX() - width / 2,
                    displayArea.getCentreY() - height / 2, width, height};
        }();
      ...
      public:
        MainContentComponent(StandaloneFilterWindow& filterWindow)
            ...
            , editor(owner.getAudioProcessor()->hasEditor()
                         ...
                         : new GenericAudioProcessorEditor(
        ...
        void resized() override
        {
            ...
            if (shouldShowNotification)
                notification.setBounds(
                    r.removeFromTop(NotificationArea::height));
        ...
        BorderSize<int> computeBorder() const
        {
            ...
            return nativeFrame.addedTo(owner.getContentComponentBorder())
                .addedTo(BorderSize<int> {
                    shouldShowNotification ? NotificationArea::height : 0, 0, 0,
                    0});
        }
